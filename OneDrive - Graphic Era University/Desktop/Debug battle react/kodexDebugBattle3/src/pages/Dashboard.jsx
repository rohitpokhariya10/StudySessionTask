    ...
    <div className="h-screen flex overflow-hidden bg-slate-50">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-3 gap-6 overflow-hidden p-6">
          <div className="col-span-2 flex flex-col overflow-hidden rounded-lg border border-slate-200 bg-white">
          ...
          <div className="flex flex-col overflow-hidden rounded-lg border border-slate-200 bg-white p-6">
            <h3 className="mb-4 shrink-0 font-bold text-slate-700">
              Add Habit
            </h3>
